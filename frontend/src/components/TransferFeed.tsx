...
export const TransferFeed: React.FC<TransferFeedProps> = ({
  ...
  return (
    <div className="rounded-2xl bg-slate-900/70 border border-slate-800/80 backdrop-blur-md p-4 sm:p-5 shadow-2xl flex flex-col h-full overflow-hidden">
      {/* Header & Controls Bar */}
      ...
      {/* Feed List */}
      <div className="mt-3.5 space-y-2.5 overflow-y-auto flex-1 min-h-0 max-h-[380px] pr-1">
